...
urlpatterns = [
    ...
    url(r'^tag_issues/$', get_posts, name='tag_issues'),
    url(r'^tag_features/$', get_posts, name='tag_features'),
    url(r'^tag_news/$', get_posts, name='tag_news'),
    url(r'^tag_other/$', get_posts, name='tag_other'),
